...
Debug::$logLevel = ("Project Root: " . TINA4_PROJECT_ROOT);
Debug::$logLevel = ("Document Root: " . TINA4_DOCUMENT_ROOT);
Debug::$logLevel = ("SubFolder: " . TINA4_SUB_FOLDER);
    ...
    if (!file_exists(TINA4_DOCUMENT_ROOT . "src")) {
        ...
        foreach ($foldersToCopy as $id => $folder) {
            if (!file_exists(TINA4_DOCUMENT_ROOT . $folder)) {
                self::recurseCopy(TINA4_PROJECT_ROOT . $folder, TINA4_DOCUMENT_ROOT . $folder);
            }
        }
    }
...
if (TINA4_PROJECT_ROOT !== TINA4_DOCUMENT_ROOT) {
    ...
    if ($tina4Checksum !== $destChecksum) {
        self::recurseCopy(TINA4_PROJECT_ROOT . "bin", TINA4_DOCUMENT_ROOT . "bin");
    }
}
